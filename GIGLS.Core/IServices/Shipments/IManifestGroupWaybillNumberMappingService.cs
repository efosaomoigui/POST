...
namespace GIGLS.Core.IServices.Shipments
{
    public interface IManifestGroupWaybillNumberMappingService : IServiceDependencyMarker
    {
        ...
        Task UpdateMappingMovementManifestToManifest(string movementmanifestCode, List<string> manifestList, int destinationScId, bool isScanner);
        ...
        Task<List<AllManifestAndGroupWaybillDTO>> GetDetailForAllTypesOfManifest(string code, string type);
    }
}