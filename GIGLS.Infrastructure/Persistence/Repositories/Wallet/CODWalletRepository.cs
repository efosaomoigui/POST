...
{
    public class CODWalletRepository : Repository<Core.Domain.Wallet.CODWallet, GIGLSContext>, ICODWalletRepository
    {
        private GIGLSContext _context;

        public CODWalletRepository(GIGLSContext context) : base(context)
        {
            _context = context;
        }
