    ...
    public class PreShipmentMobileService : IPreShipmentMobileService
    {
        ...
        public async Task ConfirmMobilePickupRequest(MobilePickUpRequestsDTO pickuprequest, string userId)
        {
            try
            {
                ...
                {
                    throw new GenericException("An error occurred while confirming request");
                }
        ...
        public async Task DeliveredMobilePickupRequest(MobilePickUpRequestsDTO pickuprequest, string userId)
        {
            try
            {
                ...
                {
                    throw new GenericException("Error occurred while trying to deliver the Shipment request");
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task LogVisitMobilePickupRequest(MobilePickUpRequestsDTO pickuprequest, string userId)
        {
            try
            {
                ...
                {
                    throw new GenericException("Error occurred while trying to Log visit");
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<object> CancelShipmentWithNoCharge(string Waybill,string Userchanneltype)
        {
            ...
            try
            {
                ...
                {
                    //var pickuprequests = await _uow.MobilePickUpRequests.GetAsync(s => s.Waybill == preshipmentmobile.Waybill && (s.Status != MobilePickUpRequestStatus.TimedOut.ToString() || s.Status != MobilePickUpRequestStatus.Rejected.ToString()));
